...
namespace Alura.ListaLeitura.App.Repositorio
{
    ...
    {
        private static readonly string nomeArquivoCSV = @"D:\Developer\Alura\Asp.NET Core Uma webapp usando o padrão MVC\Alura.ListaLeitura.Aula2\Alura.ListaLeitura\Alura.ListaLeitura.App\Repositorio\livros.csv";
